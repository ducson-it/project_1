        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div class="row">
              ...
              <a class="text-decoration-none font1 text-start" href=""
                >Xem chi chiết <i class="bi bi-chevron-right fs-6"></i
              ></a>
            </div>
          </div>
          <div class="swiper-slide">
    ...
    <div class="container-fluid bg-white">
        <div class="container py-5">
            ...
            <div class="swiper mySwiper four py-3">
                <div class="swiper-wrapper">
                  <div class="swiper-slide d-flex flex-column border border-primary pb-5">
                    <div class="p-2">
                        <img src="img/090430-uu-dai-di-kham-mediplus.jpg" alt="">
                    </div>
                    <h5 class="font1">Từ Đức Sơn</h5>
                    <h4 class="font2">Giaso sư tiến sĩ</h4>
                </div>
                <div class="swiper-slide d-flex flex-column border border-primary pb-5">
                    <div class="p-2">
                        <img src="img/090430-uu-dai-di-kham-mediplus.jpg" alt="">
